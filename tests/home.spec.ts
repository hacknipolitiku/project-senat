...
test.describe("Home page", () => {
  ...
  test("district legend shows all 27 districts", async ({ page }) => {
    ...
    const links = page.getByRole("link", {
      name: /Cheb|Louny|Plzeň|Strakonice|Pelhřimov|Příbram|Praha|Kladno|Děčín|Česká Lípa|Trutnov|Kolín|Hradec Králové|Rychnov|Žďár|Znojmo|Vyškov|Brno|Přerov|Olomouc|Frýdek|Ostrava|Karviná|Zlín|Uherské/,
    });
